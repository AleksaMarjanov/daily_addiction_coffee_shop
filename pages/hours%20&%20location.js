      ...
      <div className="w-full flex flex-col justify-center items-center mt-5">
        ...
        <div className="space-y-5 flex flex-col mt-3 items-center justify-center">
          ...
          <p className="text-lg text-center justify-center items-center">
            ...
            9AM–4PM
            <br />
            Sunday <span className="text-[#0086bb]">Closed</span>
            <br />
          </p>
        </div>
        ...
        <div className="absolute left-[45%] bottom-0 z-200 -mb-80 minmd:-mb-128">
          <button
            ...
            onClick={() =>
              router.push(
                "https://www.google.com/maps/dir/48.1574907,-103.6397794/daily+addiction+williston+nd/@48.1522838,-103.6395727,15z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x53215b6088f0b3a5:0xbadcade96cc8ebc7!2m2!1d-103.6220281!2d48.1468544"
              )
            }
          >
            Get Directions
